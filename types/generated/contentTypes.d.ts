...
export interface ApiProfileProfile extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    about_descriptions: Schema.Attribute.Relation<
      'oneToMany',
      'api::about-description.about-description'
    >;
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    name: Schema.Attribute.String & Schema.Attribute.Required;
    position: Schema.Attribute.String & Schema.Attribute.Required;
    quoteTitle: Schema.Attribute.String & Schema.Attribute.Required;
    quoteDescription: Schema.Attribute.String & Schema.Attribute.Required;
    image: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
